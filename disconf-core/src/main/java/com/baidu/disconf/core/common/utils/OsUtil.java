...
public final class OsUtil {
    ...
    public static void transfer2SpecifyDir(String srcPath, String targetPath, String fileName, boolean isMove) throws Exception {
        File srcFile = new File(pathJoin(srcPath, fileName));

        // make dir
        makeDirs(targetPath);

        File targetFile = new File(pathJoin(targetPath, fileName));
        // 从下载文件 复制/mv 到targetPath 原子性的做转移
        transferFile(srcFile, targetFile);
    }
