...
public final class RequestGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.baidu.disconf.core.grpc.auto.Message,
      com.baidu.disconf.core.grpc.auto.Message> getRequestMethod;
  ...
  public static io.grpc.MethodDescriptor<com.baidu.disconf.core.grpc.auto.Message,
      com.baidu.disconf.core.grpc.auto.Message> getRequestMethod() {
    io.grpc.MethodDescriptor<com.baidu.disconf.core.grpc.auto.Message, com.baidu.disconf.core.grpc.auto.Message> getRequestMethod;
  ...
  public static abstract class RequestImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void request(com.baidu.disconf.core.grpc.auto.Message request,
  ...
  public static final class RequestBlockingStub extends io.grpc.stub.AbstractStub<RequestBlockingStub> {
    ...
    /**
     */
    public com.baidu.disconf.core.grpc.auto.Message request(com.baidu.disconf.core.grpc.auto.Message request) {
  ...
  public static final class RequestFutureStub extends io.grpc.stub.AbstractStub<RequestFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.baidu.disconf.core.grpc.auto.Message> request(
        com.baidu.disconf.core.grpc.auto.Message request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REQUEST:
          serviceImpl.request((com.baidu.disconf.core.grpc.auto.Message) request,
              (io.grpc.stub.StreamObserver<com.baidu.disconf.core.grpc.auto.Message>) responseObserver);
          break;
        default:
